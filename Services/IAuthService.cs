...
namespace MultiDeptReportingTool.Services
{
    ...
    {
        Task<LoginResponseDto?> LoginAsync(LoginDto loginDto, string ipAddress = "::1");
        ...
        Task<bool> RevokeAllUserTokensAsync(int userId, string ipAddress, string? reason = null);
