...
Write-Host "`n🔥 Adding 12 Executive Reports..." -ForegroundColor Cyan
...
$executiveReports = @(
    ...
    @{ title = "Merger & Acquisition Analysis"; type = "Strategic"; description = "M&A opportunities and strategic partnership analysis"; status = "Pending"; priority = "High"; departmentId = 1; assignedUserId = 2; dueDate = "2025-08-28T00:00:00Z" },
...
Write-Host "`n🔍 Now test the pagination with:" -ForegroundColor Cyan
