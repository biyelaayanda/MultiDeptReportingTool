    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "FIN", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Financial operations and reporting", true, "Finance", null },
                    { 2, "HR", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Human resources management", true, "Human Resources", null },
                    { 3, "OPS", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Operational activities and processes", true, "Operations", null },
                    { 4, "COMP", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Compliance and risk management", true, "Compliance", null },
                    { 5, "IT", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "IT infrastructure and systems", true, "Information Technology", null }
                });
